...
![Why Sort Data?](svgs/why_sort_data.svg)
...
## 7. When to Use Which Sort?
*`QuadraticSorts.h` -- practical guidance on when each quadratic sort is the best choice*

![When to Use Which Sort?](svgs/when_to_use_which_sort.svg)
